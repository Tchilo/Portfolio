...
const projectCards = [
  {
    ...
    name: 'Artifacts from Chicago API museum',
    technologies: ['CSS', 'Tailwind', 'JavaScript', 'html'],
    description: 'In this project, we built a web-based API app to fetch and display art images from the Art Institute of Chicago API in an original web-designed page. The project utilizes ES6 modules, use of async and await. Individually built interfaces include a home page and a comment pop-up section.',
    button: 'See Project',
    links: ['https://www.google.com', 'https://github.com/nikoescobal/API-based-app'],
  },
  {
    id: 'card2',
    image: 'project-2.png',
    name: 'Space Travelers',
    technologies: ['Ract','JSX','CSS', 'JavaScript', 'html'],
    description: "Space Travelers is project built using React and redux. It's an app that lets you reserve rockets going to space.",
    button: 'See Project',
    links: ['https://spaceships.netlify.app/', 'https://github.com/Tchilo/spaceShips'],
  },
  {
    id: 'card3',
